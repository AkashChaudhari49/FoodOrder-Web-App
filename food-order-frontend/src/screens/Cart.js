...
const Cart = () => {
    ...
    if (data.length === 0) {
        return (
            <div className='m-5 w-100 text-center fx-3'>Cart is empty! No items added</div>
        )
    }
    ...
    const handleCheckOut = async()=>{
        ...
        console.log("order respomse:", response)
    ...
    return (
        <div>
            <div className="container m-auto mt-5 table-responsive table-responsive-sm table-responsive-md">
                ...
                <div>
                    <h2 className='fs-2'>Total Price:{totalPrice} </h2>
                </div>
                <div>
